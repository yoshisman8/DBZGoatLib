...
namespace DBZGoatLib.Model
{
    public static class Defaults
    {
        ...
        public static List<TransformationChain> Chains =
        [
        ...
        {
            dynamic modPlayer = DBZGoatLib.DBZMOD.Value.mod.Code.DefinedTypes.First(x=>x.Name.Equals("MyPlayer")).GetMethod("ModPlayer").Invoke(null,
                [player]);
        ...
        {
            TypeInfo modPlayerClass = DBZGoatLib.DBZMOD.Value.mod.Code.DefinedTypes.First(x => x.Name.Equals("MyPlayer"));
        ...
        public static void DoGeneticWish_Detour()
        {
            ...
            TypeInfo WishMenu = DBZGoatLib.DBZMOD.Value.mod.Code.DefinedTypes.First(x => x.Name.Equals("WishMenu"));
